...
class DefaultTypedPropertiesTest {
    ...
    @Test
    fun `Assert that nullable marker can store null`() {
        properties[shoeSize] = null

        assertThat(properties.containsKey(shoeSize)).isTrue()
        assertThat(properties[shoeSize]).isNull()
        assertThat(properties.getValue(shoeSize)).isNull()
    }
